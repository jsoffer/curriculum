...
Licenciado en Ciencia de la Computación con amplia trayectoria en desarrollo
y difusión del software libre. Más de diez años de experiencia en C y Python.
Capacidad de liderazgo, dirección de personal, proyectos y actividades. Adaptación
a diferentes condiciones tecnológicas, pensamiento crítico y resolución de problemas.
...
\subsection{Idiomas}
\cvitem{nativo}{Español}
\cvitem{avanzado}{Inglés; conversación, lectura, escritura}

\subsection{Lenguajes de Programación}
\cvitem{principales}{Python, C/C++, SQL (MySQL, PostgreSQL), Haskell}
\cvitem{secundarios}{Ruby, Javascript, sh/bash/zsh, Clojure}
\cvitem{otros}{Assembly x86, Fortran, GAP, Java,
OCaml, Octave, PARI/GP, Perl, PHP, Prolog, R, Scheme, Tcl, VHDL}

\subsection{Tecnologías}

\cvitem{sistemas}{Administración de Linux (Ubuntu) y FreeBSD}
\cvitem{plataformas}{HTML/CSS; OpenGL, Qt, PyQt; mantenimiento a Wordpress, Django, RoR}
\cvitem{herramientas}{LaTeX, vim, git, graphviz, valgrind}

\section{Varios}

\cventry{2007}{Consejo Divisional CBI}{UAM Iztapalapa, División de Ciencias Básicas e Ingeniería}{Representante Suplente}{}{} %fixme check year

\cventry{2006-2008}{CEUAMI}{UAM Iztapalapa, Capítulo Estudiantil de Ciencias de la Computación}{Miembro Representante en la Mesa Directiva}{}{}

\cventry{2004-}{Coro Rinah}{Comunidad Nidjei Israel}{Voz de Bajo}{}{}
